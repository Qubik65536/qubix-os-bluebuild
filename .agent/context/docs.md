...
| `design-decisions.md` | `DD-001`…`DD-060` — every "why" in the project | Before questioning any convention |
...
| `build-and-release.md` | Weekly OCI and automatic/manual ISO workflows, trigger chaining, permissions, signing, Microsoft 365 OIDC/OneDrive setup, 3 scheduled + 5 push/manual retention, per-variant GitHub Release indexing and three-month cleanup, storage capacity, tags, failure triage | Changing CI or debugging a build |
| `usage.md` | Install, update, rollback, verify, automatically or manually build/download/check a GitHub-indexed, OneDrive-hosted ISO, uninstall | Answering a user-facing question |
