...
| `design-decisions.md` | `DD-001`…`DD-054` — every "why" in the project | Before questioning any convention |
...
| `build-and-release.md` | OCI and manual ISO workflows, triggers, permissions, signing, artifacts, tags, failure triage | Changing CI or debugging a build |
