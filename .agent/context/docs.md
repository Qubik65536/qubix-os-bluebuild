...
| `design-decisions.md` | `DD-001`…`DD-061` — every "why" in the project | Before questioning any convention |
...
| `usage.md` | Install/rebase app-delivery differences, the inherited `ublue-os` Homebrew tap and Zed command, update, rollback, verify, build/download/check an ISO, uninstall | Answering a user-facing question |
