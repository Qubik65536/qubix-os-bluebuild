...
| `design-decisions.md` | `DD-001`…`DD-055` — every "why" in the project | Before questioning any convention |
...
| `build-and-release.md` | Weekly OCI and manual ISO workflows, triggers, permissions, signing, artifacts, tags, failure triage | Changing CI or debugging a build |
| `usage.md` | Install, update, rollback, verify, dispatch/download/check an ISO artifact, uninstall | Answering a user-facing question |
