...
|---|---|---|
| `files/system/usr/share/qubix-os/grub-theme/background.png` | `/boot/grub2/themes/qubix-v1-*/background.png` | GRUB desktop artwork F: near-black terminal grid and the cropped Qubix wireframe cube. |
...
| Generated by `common-base.yml` module 4j | `…/qubix-mono-{16,20}.pf2`, `…/qubix-mono-bold-20.pf2` | IBM Plex Mono converted from OTF into the PF2 bitmap format GRUB can load. |
